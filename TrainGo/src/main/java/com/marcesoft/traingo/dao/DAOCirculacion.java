...
import com.marcesoft.traingo.aplicacion.Tren;
...
import com.marcesoft.traingo.aplicacion.excepciones.ProcesadoSiguienteEventoException;
...
import static com.marcesoft.traingo.dao.constantes.TagsXMLCirculacion.*;
...
public class DAOCirculacion extends AbstractDAO {
    ...
    /**
     * Constructor de DAOCirculacion
     *
     * @param fa_dao la fachada DAO
     */
...
//        Circulacion circulacion = Circulacion.fabricarCirculacion(trenId, uuid, ruta, estado, horaSalida, horaLlegadaReal, precioPorAsiento);
    ...
    /**
     * Comprueba si el evento está dentro de la hora.
     * De uso interno
     */
